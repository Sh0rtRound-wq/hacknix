...
PanelWindow {
    ...
    function executeSwitch(newWidget, arg, immediate) {
        ...
        if (newWidget === "wallpaper") props["closeCallback"] = () => switchWidget("hidden", "");
        ...
        if (cached) {
            ...
            if (newWidget === "wallpaper" && cached.closeCallback !== undefined) cached.closeCallback = () => switchWidget("hidden", "");
